  ...
  const drawer = (
    <Box sx={{ width: 280, p: 2 }}>
      ...
      <List>
        ...
        <ListItem component={RouterLink} to="/admin" onClick={() => setDrawerOpen(false)}>
        ...
        {inAdmin && (
          <>
            ...
            <ListItem component={RouterLink} to="/admin/blog" onClick={() => setDrawerOpen(false)}>
              <ListItemText primary="Admin · Blog" />
            </ListItem>
            <ListItem component={RouterLink} to="/admin/redirects" onClick={() => setDrawerOpen(false)}>
              <ListItemText primary="Admin · Redirections" />
            </ListItem>
            <ListItem component={RouterLink} to="/admin/seo-checks" onClick={() => setDrawerOpen(false)}>
              <ListItemText primary="Admin · Vérifs SEO" />
            </ListItem>
